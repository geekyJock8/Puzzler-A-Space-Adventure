...
public class GameLogic : MonoBehaviour
{
    ...
    public GameObject startPoint, playPoint, restartPoint, planetAPoint, planetBPoint, planetCPoint;
    ...
    void Start()
    {
        ...
        Debug.Log("Entering GeneratePuzzleSequence");
    ...
    void DisplayPattern()
    {
        ...
        Debug.Log("Entering Display Pattern");
        ...
        Debug.Log("Exited DisplayPattern");
    }
    ...
    {
        Debug.Log("Entered SolutionCheck");
        ...
        Debug.Log("Exited SolutionCheck");
    }
    ...
    public void MoveToPlanetA()
    {
        iTween.MoveTo(player,
            iTween.Hash(
            "position", planetAPoint.transform.position,
            "time", 30,
            "easetype", "linear"
            )
        );
